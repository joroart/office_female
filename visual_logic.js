...
setHTMLElemStyle('display', 'none', 'speakButton', false);
setHTMLElemStyle('display', 'none', 'textArea', false);
...
_initGlob.output.initOptions.preloaderEndCb = function() {
    ...
    (function() {
  setHTMLElemStyle('display', 'none', 'v3d-container', false);
  setHTMLElemStyle('display', 'block', 'testButton', false);
  setHTMLElemStyle('display', 'block', 'speakButton', false);
  setHTMLElemStyle('display', 'block', 'textArea', false);
})();
};
...
if (v3d.PL.editorRenderCallbacks)
    v3d.PL.editorRenderCallbacks.push([appInstance, processAnimTriggers]);
...
operateAnimation('STOP', 'Point001', null, null, 'AUTO', 1,
        function() {}, false);


eventHTMLElem('click', 'startButton', false, function(event) {
  setHTMLElemStyle('display', 'block', 'v3d-container', false);
  setHTMLElemStyle('display', 'none', 'testButton', false);

  operateAnimation('PLAY', 'Bip001', null, null, 'LoopOnce', 1,
          function() {}, false);


  operateAnimation('PLAY', 'Point001', null, null, 'LoopOnce', 1,
          function() {}, false);

      });

onAnimationFrameDo('Bip001', 55, function() {
  getJSFunction('saySmt')();
});
